...
namespace WebApplication1.Controllers
{
    public class OgrencisController : Controller
    {
        ...
        public OgrencisController(Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,SurName,SchoolNumber,Phone,Address,EğitimDurumu")] Ogrenci ogrenci)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,SurName,SchoolNumber,Phone,Address,EğitimDurumu")] Ogrenci ogrenci)
        {
            if (id != ogrenci.Id)
            {
                return NotFound();
